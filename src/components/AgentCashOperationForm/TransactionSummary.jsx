    ...
    <div className="bg-white rounded-xl border border-gray-200 p-6">
      ...
      <div className="space-y-6">
        <div className="flex justify-between items-center pb-4 border-b border-gray-200">
          ...
          <span
            className={`px-4 py-2 rounded-full font-medium ${commissionOption === 'excluding' ? 'bg-teal-100 text-teal-700' : 'bg-gray-100 text-gray-700'}`}
          >
        ...
        <div className="space-y-3 pl-4 border-l-2 border-gray-200">
          ...
          {agentCommission > 0 && amounts.commission > 0 && (
            <div className="flex justify-between items-center">
              ...
              <span
                className={`font-semibold ${commissionOption === 'excluding' ? 'text-red-600' : 'text-yellow-600'}`}
              >
                {commissionOption === 'excluding' ? '+' : '-'}
                {amounts.commission.toFixed(2)} {currency}
              </span>
            </div>
          )}
        </div>
