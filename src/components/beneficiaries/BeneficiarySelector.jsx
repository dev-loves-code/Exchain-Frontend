...
import { Search, User, Wallet, CreditCard, Building2, Check } from "lucide-react";
...
export default function BeneficiarySelector({ onSelect }) {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg p-8">
      <h2 className="text-2xl font-black text-gray-900 mb-4">Select Beneficiary</h2>
          ...
          filtered.map((b) => {
            ...
            return (
              ...
              >
                ...
                <div className={`flex items-center gap-2 px-3 py-2 ${payment.bg} rounded-lg ${payment.color}`}>
