...
export default function FilterCard({ filters, onFilterChange, onClearFilters, onApplyFilters }) {
  return (
    <div className="bg-white rounded-xl shadow-sm p-6 mb-8 border border-gray-200">
      ...
      <div className="flex justify-end mt-6 space-x-3">
        ...
        <button
          ...
          className="px-5 py-2.5 bg-teal-800 hover:bg-teal-900 text-white rounded-xl font-medium transition-all duration-200 shadow-sm hover:shadow"
        >
          Apply Filters
        </button>
      </div>
